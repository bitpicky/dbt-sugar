"""Contains documentation related utils."""
import logging
import os
from pathlib import Path
from typing import Any, Dict, List

from dbt_sugar.core.yaml_module.yaml_helpers import open_yaml, save_yaml
...
class Documentation:
    """Class to administrate the documentation in DBT."""
    ...
    def update_model(
        ...
        """
        logging.info("The model already exists, update the model.")
        for model in content.get("models", []):
            if model["name"] == model_name:
                for column in columns_sql:
                    ...
                    if column not in columns_names:
                        ...
                        logging.info(f"Updating column with name {column}")
    ...
    def create_new_model(
        ...
        """
        logging.info("The model doesn't exists, creating a new model.")
        columns = []
